...
![Kuvaus organisaation ympäristöstä](/assets/images/ymparisto.png)
<em>Kuva 1. Esimerkki kuvaus organisaation ympäristöstä (Cisco Packet Tracer)</em>

**Miten varmistetaan, että ympäristöön ei pääse ulkopuolisia**

- Segmentoidaan verkko
	- Sisäinen verkko: valtuutetuille henkilöille
	- vierailijaverkko: rajoitetuilla oikeuksilla
- Pakettisuodatus IP osoitteen perusteella.
- Lähiverkon työasemat ja palvelimet ovat eristettyinä ja suojattu palomuurilla
- Langaton verkko eristetty langallisesta verkosta
- Julkisesti näkyvät palvelut sijoitetaan DMZ-verkkoon ja suojataan palomuurilla. DMZ:n ja lähiverkon välillä palomuuri sekä DMZ:n ja Internetin välillä palomuuri

**Epäilyttävien tiedostojen tutkiminen**

- Preliminäärinen analysointi, tarkistetaan tiedostopääte. Esim. Windowsilla -> 'Properties'
- Epäilyttäviä tiedostoja ei avata tuotannon ympäristössä.
- Luodaan sandbox testiympäristö, poimitaan epäilyttävät tiedostot ja tutkitaan tarkemmin eristetyssä tietokoneessa/verkossa.
...
https://terokarvinen.com/sovellusten-hakkerointi/#h1-korkeat-standardit-lari
# Korkeat Standardi
...
| Tietoturvallisuus Ohjelmistokehityksessä | Riskienhallintasuunnitelma
...
- SFS Suomen Standardit ry 2020. SFS-EN ISO/IEC 27000:2020. Luettavissa: https://sales.sfs.fi/fi/index/tuotteet/SFS/CENISO/ID2/2/914943.html.stx#:~:text=T%C3%A4ss%C3%A4%20asiakirjassa%20esitet%C3%A4%C3%A4n%20tietoturvallisuuden%20hallintaj%C3%A4rjestelmien%20yleiskuvaus.%20Siin%C3%A4,voivat%20soveltaa%20kaikentyyppiset%20ja%20-kokoiset%20organisaatiot%20(esim.. Luettu 21.8.2025
- CEN/CENELEC 2020. ISO27000-2020-en. Sovellusten hakkerointi ja haavoittuvuudet-opintojakson PDF-materiaali Moodlessa. Haaga-Helia ammattikorkeakoulu. Luettu 21.8.2025
